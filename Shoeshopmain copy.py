...
names=["Louis", "Gian", "Mikara", "Joaquin", "Tomboy",
 "BigBen", "Calicdan", "Barlo", "Yacob", "Marcas"]

#list of shoesnames
icecream_names = ['Chocolate', 'Vannila', 'Choc Fudge', 'Mint ChocChip',
                    'Strawberry', 'Rocky Road', 'Mango',
                    'Cookies n Cream', 'Cookie Dough','Salted Caramel',
                    'Butter Pecan', 'Creamy Mystery']

#list of shoesprices
icecream_prices = [4.00, 4.00, 4.50, 4.50, 4.00, 4.50, 4.00, 4.00, 4.00, 4.50, 4.50, 5.00]
...
def order_icecream():
    ...
    for item in range (num_icecream):
            while num_shoes> 0: 
                ...
                question = (f"Enter a number between {NUM_LOW} and {NUM_HIGH} ")
                icecream_ordered = val_int(NUM_LOW,NUM_HIGH,question)
